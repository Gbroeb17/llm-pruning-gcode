...
BASE_MODEL_DIR = "/home/aichen/llm-pruning-gcode/granite3b-pruneme-skip6-block18to23"

TRAIN_JSONL = "/home/aichen/project_data/training_data/dataset_no_rule/train.jsonl"
VALID_JSONL = "/home/aichen/project_data/training_data/dataset_no_rule/valid.jsonl"

OUTPUT_DIR = "/home/aichen/llm-pruning-gcode/qlora_runs/spark_evalbs1_ep2"
MERGED_SAVE_DIR =  "/home/aichen/llm-pruning-gcode/granite3b-pruneme-qlora-spark-evalbs1-ep2"
...
# eval batch = 8
# → OOM warning
# → peak reserved 112.41 GB
# → validation ≈ 4 h 3 min
...
training_args = TrainingArguments(
    ...
    per_device_eval_batch_size=1, #新增 validation 一次只跑 1 筆，而不是 8 筆，這應該會大幅降低瞬間 GPU/unified memory
    ...
    prediction_loss_only=True, #新增 現在 validation 主要只是要看 eval_loss，就不要額外保留完整 logits/predictions，進一步減少 memory usage。
    save_strategy="steps",
...
print(f"\nPeak GPU memory allocated: {peak_allocated_gb:.2f} GB")
