...
# Adjust to your actual block range — check the folder name you got
TRAIN_JSONL = "/workspace/project_data/training data/dataset_no_rule/train.jsonl"
VALID_JSONL = "/workspace/project_data/training data/dataset_no_rule/valid.jsonl"
#VALID_SPLIT_RATIO = 0.05   # 5% from train.jsonl as validation
OUTPUT_DIR = "/workspace/llm-pruning-gcode/qlora_runs/pruneme_qlora_s12288_ep2"
MERGED_SAVE_DIR = "/workspace/llm-pruning-gcode/granite3b-pruneme-qlora-s12288-ep2"
