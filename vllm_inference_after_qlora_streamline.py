...
MODEL_DIR = "/workspace/llm-pruning-gcode/granite3b-pruneme-qlora-s12288-ep2-streamline8192-cosine1.0"
INFERENCE_INPUT_DIR = Path("/workspace/project_data/test_data/inference_input")
INFERENCE_OUTPUT_DIR = Path("/workspace/llm-pruning-gcode/results/pruneme_qlora_streamline/inference_1000")
TIMING_CSV_PATH = Path("/workspace/llm-pruning-gcode/results/pruneme_qlora_streamline/timing_1000.csv")
