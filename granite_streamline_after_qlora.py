...
def parse_args():
    ...
    parser.add_argument("--original_model_dir",default="/workspace/project_data/model/granite_gcode_merged_best_new") # Streamline 的 Teacher
    #parser.add_argument("--pruned_model_dir", default="/workspace/llm-pruning-gcode/granite3b-pruneme-skip6-block18to23")
    parser.add_argument("--pruned_model_dir",default="/workspace/llm-pruning-gcode/granite3b-pruneme-qlora-s12288-ep2") #現在 Streamline 的 Student : 直接改成上次跑的pruneme+qlora的模型
    #parser.add_argument("--train_jsonl", default="/workspace/training_data/dataset_no_rule/train.jsonl")
    parser.add_argument("--train_jsonl",default="/workspace/project_data/training data/dataset_no_rule/train.jsonl")
    #parser.add_argument("--output_dir", default="/workspace/llm-pruning-gcode/granite3b-streamline-full-ep3-seqlen8192-cosine1.0")
    parser.add_argument("--output_dir",default="/workspace/llm-pruning-gcode/granite3b-pruneme-qlora-s12288-ep2-streamline8192-cosine1.0") #new name :防止蓋掉以前 Streamline 模型
